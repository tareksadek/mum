...
;// CONCATENATED MODULE: ./public/service-worker.ts
...
registerRoute(({ request }) => request.destination === 'style' || request.destination === 'script', new StaleWhileRevalidate({
...
registerRoute(({ url }) => url.origin === 'https://firebasestorage.googleapis.com' &&
    url.pathname.startsWith('/v0/b/muchmum-00.appspot.com'), new CacheFirst({
